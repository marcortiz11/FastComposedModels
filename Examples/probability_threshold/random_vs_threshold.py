...
def build_train_trigger(model1_dict, th):
    ...
    io.save_pickle('../../Definitions/Triggers/Tmp/trigger_random_threshold', classifier_trigger_dict)
    classifier = make.make_classifier("trigger_classifier", "../../Definitions/Triggers/Tmp/trigger_random_threshold")
    return classifier
