...
class TestMerger(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.c1 = ClassifierMetadata(
            os.path.join(os.environ["FCM"], "Definitions/Classifiers/sota_models_cifar10-32-dev_validation/V001_DenseNet121_ref_0.pkl"))
        self.c2 = ClassifierMetadata(
            os.path.join(os.environ["FCM"], "Definitions/Classifiers/sota_models_cifar10-32-dev_validation/V001_DenseNet121_ref_0.pkl"))
        self.c3 = ClassifierMetadata(
            os.path.join(os.environ["FCM"], "Definitions/Classifiers/sota_models_cifar10-32-dev_validation/V001_MobileNetV2_ref_0.pkl"))
